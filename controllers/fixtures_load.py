...
def fct_fixtures_load():
    ...
    # Creating the 'coupe_jean' table
    mycursor.execute('''
    CREATE TABLE coupe_jean (
        id_coupe_jean INT PRIMARY KEY,
        nom_coupe VARCHAR(50)
    );
    ''')

    # Inserting data into 'coupe_jean'
    mycursor.execute('''
    ...
    # Creating the 'ligne_commande' table
    mycursor.execute('''
    ...
    # Inserting data into 'ligne_commande'
    mycursor.execute('''
    ...
    # Creating the 'ligne_panier' table
    mycursor.execute('''
    ...
    # Inserting data into 'ligne_panier'
    mycursor.execute('''
